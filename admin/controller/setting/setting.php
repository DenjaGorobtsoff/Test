...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_partnership_text'])) {
		...
		if (isset($this->request->post['config_partnership_tax'])) {
			$data['config_partnership_tax'] = $this->request->post['config_partnership_taz'];
		}else{
